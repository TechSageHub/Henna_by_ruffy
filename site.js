...
function renderFooter() {
  ...
  footerHost.innerHTML = `<footer class="site-footer"><div class="container"><div class="footer-card"><div><p class="eyebrow">Henna_by_ruffy</p><h3>Signature henna services rooted in artistry and built for expansion.</h3><p>Luxury, long-lasting henna designs, professional beauty training, and premium henna tools under one elegant brand direction.</p></div><div><h3>Pages</h3><div class="footer-links">${navItems.map(([label, href]) => `<a href="${href}">${label}</a>`).join("")}</div></div><div><h3>Contact</h3><div class="footer-contact"><a href="tel:+2348000000000">+234 800 000 0000</a><a href="mailto:hello@hennabyruffy.com">hello@hennabyruffy.com</a><a href="https://instagram.com" target="_blank" rel="noopener">Instagram</a></div></div></div></div></footer>`;
}
